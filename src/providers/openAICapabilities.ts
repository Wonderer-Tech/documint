 ...
 *
 * Values for GPT-4.1, GPT-5, and GPT-5.4 families are aligned with current
 * OpenAI model documentation. Older families retain DocuMint's compatibility
 * limits until their support is intentionally removed.
 */
